...
public class TestaMedicos {
	...
	public void testaToString () {
		Assert.assertEquals("Nome: Adriano - Número de contribuinte: 12345", med1.toString());
		Assert.assertEquals("Nome: João - Número de contribuinte: 91234", med2.toString());
		Assert.assertEquals("Nome: Adriana - Número de contribuinte: 81329", med3.toString());
	}
	...
	public void testaEquals () throws Exception {
		...
		med1 = new Medicos("João", "91234", PACIENTES2, GASTOS_CONGRESSOS2, VALOR_ACIMA_CARRO, VALOR_ACIMA_CASA);
