...
public class TestaTaxista {
	...
	public void testaLimiarRiqueza () throws Exception {
		...
		Assert.assertFalse(Taxista.getTaxistas().get(0).getAcimaDaLimiar());
		Assert.assertTrue(Taxista.getTaxistas().get(1).getAcimaDaLimiar());
		Assert.assertFalse(Taxista.getTaxistas().get(2).getAcimaDaLimiar());
		}
