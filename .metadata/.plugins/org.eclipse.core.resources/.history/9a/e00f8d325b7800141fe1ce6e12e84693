...
public class TestaCaminhoneiro {
	...
	public void TestaConstrutor () throws Exception {
		...
		Assert.assertEquals(3, Caminhoneiro.getNumeroDeCaminhoneiros());
	...
	public void testaLimiarRiqueza () throws Exception {
		...
		Assert.assertEquals(535000, Caminhoneiro.getLimiarRiqueza(), 0.01);
		Assert.assertFalse(Caminhoneiro.getCaminhoneiros().get(0).getAcimaDaLimiar());
		Assert.assertFalse(Caminhoneiro.getCaminhoneiros().get(1).getAcimaDaLimiar());
		Assert.assertTrue(Caminhoneiro.getCaminhoneiros().get(2).getAcimaDaLimiar());
		}
